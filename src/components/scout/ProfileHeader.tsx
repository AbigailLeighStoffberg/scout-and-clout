...
export function ProfileHeader({ className }: ProfileHeaderProps) {
  ...
  return (
    <motion.div
      ...
      className={cn("relative h-32 sm:h-40 w-full rounded-2xl sm:rounded-3xl overflow-hidden mb-4 sm:mb-6", className)}
    >
      {/* Hidden file inputs */}
      <input
        ref={coverInputRef}
      ...
      <div className="relative z-10 h-full flex items-center px-4 sm:px-8">
        ...
        <div>
          <motion.h1
            ...
            className="text-lg sm:text-2xl md:text-3xl font-extrabold text-white drop-shadow-lg line-clamp-1"
