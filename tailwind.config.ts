  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Direct hex colors for specific use
        "influencer-start": "#A759D8",
        "influencer-end": "#DB529F",
        "partner-main": "#1DB09B",
        "shared-text": "#18C5DC",
        sidebar: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(var(--vibe-pink) / 0.5)" },
          "50%": { boxShadow: "0 0 40px hsl(var(--vibe-pink) / 0.8)" },
        },
        float: {
      ...
      backgroundImage: {
        ...
        "influencer-gradient": "linear-gradient(135deg, #A759D8, #DB529F)",
      },
      backgroundSize: {
        grid: "40px 40px",
      },
